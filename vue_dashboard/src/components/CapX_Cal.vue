...
export default{
  ...
  watch: {
    ...
    dateInterval() {
      this.dataInterval = this.dateInterval
    },
  ...
  methods: {
    ...
    drawChartCal() {
      ...
      // if (this.dateInterval == "Monthly") {
      //   this.yaxis = this.monthlySchedule
      //   console.log(this.monthlySchedule)
      // } else if (this.dateInterval == "Hourly") {
      //   this.yaxis = this.hourlySchedule  
      //   console.log(this.hourlySchedule)
      // }
